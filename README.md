...
In image applications, the output will be multiplied by 255/2 and rounded to the nearest value. A 0.01 error can lead a 1/255 difference in the RGB value. Probably not a big issue, but it's something to consider.
